...
with open('./Data/JSON/JSON_NEW_25th_26th.json', 'r') as json_file:
    dfcols = ['Order Number','Order Date','Ship Method','Ship To State','Quantity']
    orders = json.load(json_file)
    print(parse_all_orders(orders["Records"]))
