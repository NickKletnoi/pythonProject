...
while page <= Totalpages:
    ...
    for order in data['Records']:
            ...
            engraved_name = order['OrderLines'][0]['ExtendedAttributes'][10]['Name']
            if (engraved_name == 'Engraved'):
                engraved = order['OrderLines'][0]['ExtendedAttributes'][10]['Value']
            else:
                engraved = '-'
...
df.to_sql('stg_order1', connStringRed, index=False, if_exists='append', schema='rb')
