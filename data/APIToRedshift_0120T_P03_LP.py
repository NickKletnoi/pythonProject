...
def parse_single_order_line_v1(order_line):
    ...
    return {
        ...
        "SKU": order_line["ItemIdentifier"]["SupplierSKU"] if "SupplierSKU" in order_line["ItemIdentifier"] else "-",
        ...
        "IsDropShip": order_line["IsDropShip"] if "IsDropShip" in order_line else False,
        "RetailPrice": order_line["RetailPrice"] if "RetailPrice" in order_line else "-",
